...
SIMPLE_PROPERTY(evolution_fitness_non_negative)
    EvolutionConfig config;
...
SIMPLE_PROPERTY(evolution_mutation_rate_valid)
...
SIMPLE_PROPERTY(evolution_crossover_rate_valid)
...
SIMPLE_PROPERTY(evolution_elitism_count_valid)
    uint32_t population_size = 50 + (rng() % 950); // 50-1000
...
SIMPLE_PROPERTY(evolution_fitness_improvement)
    EvolutionConfig config;
    config.population_size = 100;
